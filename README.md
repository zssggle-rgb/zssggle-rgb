...
长期从事央国企与大型企业人工智能应用建设、智能体系统实施及工程化交付相关工作，重点面向复杂业务流程数字化改造、知识型工作智能化支撑、研究分析类应用建设等方向，提供从场景研判、总体方案、技术架构到实施落地的全链路支撑。
...
- [openclaw/openclaw](https://github.com/openclaw/openclaw)：OpenClaw 工程修复、执行链路优化与工作流可靠性改进
- [deer-flow](https://github.com/zssggle-rgb/deer-flow)：面向实际交付场景的 deep research 工作流工程实践
- [agent-delivery-lab](https://github.com/zssggle-rgb/agent-delivery-lab)：人工智能工程化交付相关的公开实验与方法沉淀
...
- [openclaw/openclaw](https://github.com/openclaw/openclaw): workflow reliability and engineering improvements
- [deer-flow](https://github.com/zssggle-rgb/deer-flow): deep-research workflow engineering for practical AI delivery
- [agent-delivery-lab](https://github.com/zssggle-rgb/agent-delivery-lab): public experiments and delivery-oriented AI engineering artifacts
